<h1 align="center">Hi, I'm Atharv Agarwal 👋</h1>
<h3 align="center">Software Engineer building at the intersection of AI, data systems, and mobile/IoT</h3>

<p align="center">
  CS Undergrad @ VIT Chennai &nbsp;·&nbsp; Ex-Product Engineering Intern @ Epsilon &nbsp;·&nbsp; Ex-Data Science Intern @ Five Angstrom
</p>
...
**Languages**
`Java` `Python` `C++` `Kotlin` `SQL` `R` `JavaScript`

**AI / ML / LLM Systems**
`MCP (Model Context Protocol)` `RAG` `PySpark` `Databricks Vector Search` `scikit-learn` `Pandas` `NumPy`

**Backend & Data**
`FastAPI` `Flask` `Databricks Unity Catalog` `Delta Lake` `PostgreSQL` `Prisma ORM` `Serverless SQL Warehouses`

**Frontend**
`React` `Next.js` `HTML/CSS` `Tailwind CSS`

**Mobile & IoT**
`Kotlin` `Android Studio` `Firebase` `Arduino`

**Cloud & Tools**
`AWS` `Git/GitHub` `Postman` `Power BI` `Tableau`
...
- Agentic AI patterns: tool-calling, MCP servers, and multi-step LLM reasoning over real data sources
- RAG architectures using vector search over structured/semi-structured data
- Applying data pipeline reliability practices (bronze/silver/gold validation) to AI-assisted systems
